...
public class ShopData {
    ...
    public ShopData(String zoneId) {
        ...
        this.restockSchedule = RestockSchedule.DAILY;
    ...
    public static ShopData load(String zoneId, File file) {
        ...
        data.setRestockSchedule(parseEnum(RestockSchedule.class, config.getString("restock-schedule", "DAILY"), RestockSchedule.DAILY));
