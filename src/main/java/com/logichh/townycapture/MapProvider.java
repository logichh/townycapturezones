 ...
 * markers and regions for capture points.
 */
public interface MapProvider {
    ...
    /**
     * Create or update a marker for a capture point.
     * 
     * @param point The capture point to create a marker for
     */
    void createOrUpdateMarker(CapturePoint point);
    
    /**
     * Remove a marker for a capture point.
     * 
     * @param pointId The ID of the capture point
     */
    void removeMarker(String pointId);
    
    /**
     * Update all markers to reflect current capture point states.
     */
